...
Configure the application with details of the Auth0 domain and client ID of your application. Locate the `/app/src/main/res/values/strings.xml` file and replace the placeholder `4UYSJHpdJsKZUcGt7Fo5X8C8BUg6iV2t` and `dev-785bgoj4.us.auth0.com` values with your application's client ID and domain.
...
<resources>
    ...
    <string name="com_auth0_client_id">4UYSJHpdJsKZUcGt7Fo5X8C8BUg6iV2t</string>
    <string name="com_auth0_domain">dev-785bgoj4.us.auth0.com</string>
